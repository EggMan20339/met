...
class Game {
  ...
  render() {
    ...
    if (this.nearInteract && this.state === 'play') { const d = this.nearInteract; const above = Art.ready ? ({ N: 24, W: 22, Q: 20, K: 24, B: 14 }[d.type] || 12) : 10; drawPrompt(ctx, d.tx * TILE + 8, d.ty * TILE - above, t); }
    drawPlayer(ctx, p, t);
